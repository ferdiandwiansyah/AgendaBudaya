  ...
  return (
    <footer className="mt-10 border-t border-emerald-100/60 bg-white/70 backdrop-blur">
      <div className="container mx-auto max-w-6xl px-4 py-10">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-3">
          ...
          <div>
            <Link href="/" className="inline-flex items-center gap-2 no-underline">
              {/* ganti kotak 'E' -> logo */}
              <Image
                src="/logo.rmv.png"           // pastikan file ada di /public/logo.rmv.png
                alt="Logo Agenda Budaya"
                width={36}
                height={36}
                className="h-12 w-auto select-none"
                priority
              />
              <span className="text-md font-semibold text-zinc-900">Agenda Budaya</span>
            </Link>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-zinc-600">
              <li className="flex items-start gap-3">
                ...
                <span>
                  Jl. Raya KH. Abdul Halim No.311, Majalengka Wetan, Kec. Majalengka, Kabupaten Majalengka, Jawa Barat 45411
                </span>
              </li>
              <li className="flex items-start gap-3">
                <svg
                ...
                <a
                  href="mailto:disparbud@jabarprov.go.id"
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+622338294553" className="hover:text-emerald-700">
                  (0233) 8294553
                </a>
              </li>
            </ul>
        ...
        {/* Bottom bar */}
        <div className="mt-10 flex flex-col items-center justify-between gap-3 border-t border-zinc-200/70 pt-6 sm:flex-row">
