      ...
      <main className="mx-auto grid max-w-7xl grid-cols-1 place-items-center px-4 py-12 sm:py-16">
        <div className="w-full max-w-md">
          ...
          <div className="overflow-hidden rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
            ...
            <label className="mt-4 block text-sm font-medium text-zinc-800">
              ...
              <div className="mt-1 relative">
                ...
                >
                  ...
                  <span className="sr-only">{showPw ? "Sembunyikan" : "Tampilkan"}</span>
                </button>
              </div>
            </label>
            ...
            {error && (
              <p className="mt-3 rounded-xl bg-red-50 px-3 py-2 text-sm text-red-700" role="alert" aria-live="assertive">
                {error}
              </p>
            )}

            {/* Navigasi ke Setup Admin */}
          ...
          <p className="mt-6 text-center text-sm">
            <Link
              href="/"
              className="no-underline inline-flex items-center gap-1.5 rounded-lg px-2 py-1 text-sm font-semibold text-zinc-800 hover:text-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-600"
            >
